...
This playbook turns the installed CLI stack into friendly, practical workflows for day-to-day engineering leadership, so teams can move faster with less friction.
...
Tool-specific cheatsheets (pick one and get productive in minutes):
...
### 🛡️ Scenario 2: Release hardening before merge
...
- Run `trivy fs .` at least once before opening a PR to catch easy security issues early.
